...
export default function LoginPage() {
  ...
  // 2FA: cuando el backend pide el paso de verificación
  ...
  async function onSubmit(data: FormData) {
    ...
    try {
      ...
      // Si el usuario tiene 2FA, el backend devuelve requires_2fa=true
  ...
  // Si el backend pidió 2FA, mostrar el paso de verificación
  if (twoFactorToken) {
    return (
      <TwoFactorPage
  ...
  return (
    <div className="auth-page auth-gradient flex items-center justify-center p-4">
      ...
      <div className="auth-card w-full max-w-sm">
        ...
        {/* Botones OAuth — redirigen al backend que inicia el flujo OAuth */}
